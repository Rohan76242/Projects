...
class MediaAndIntentTests(unittest.TestCase):
    ...
    def test_playback_intents(self):
        ...
        cases = [
            ...
            ("stop it", "stop_song"),
            ("stop", "stop_song"),
            ("close the song", "stop_song"),
            ("close song", "stop_song"),
            ("turn off the song", "stop_song"),
            ("turn off song", "stop_song"),
            ("stop youtube", "stop_song"),
            ("close youtube", "stop_song"),
            ("its not stopping the song", "stop_song"),
            ("not stopping the song", "stop_song"),
            ("stop the song fix it", "stop_song"),
            ("shut up", "stop_song"),
            ("be quiet", "stop_song"),
            ("pause song", "pause_song"),
            ("pause the song", "pause_song"),
            ("pause it", "pause_song"),
            ("pause", "pause_song"),
            ("resume song", "resume_song"),
            ("resume it", "resume_song"),
            ("unpause", "resume_song"),
            ("resume", "resume_song"),
